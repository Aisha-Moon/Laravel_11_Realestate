                ...
                <div class="p-3 border-bottom d-flex align-items-center justify-content-between flex-wrap">
                  <div class="d-none d-md-flex align-items-center flex-wrap">
                    ...
                    <div class="btn-group me-2">
                      ...
                      <a href="" class="btn btn-outline-primary" onclick="return confirm('Are you sure want to delete?')" id="getDeleteUrl">Delete</a>
                    </div>
                  ...
                  <div class="email-list-item email-list-item--unread">
                    <div class="email-list-actions">
                      <div class="form-check">
                        <input type="checkbox" class="form-check-input delete-all-option" value="{{ $email->id }}">
                      </div>
