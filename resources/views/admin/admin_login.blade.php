                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <img src="{{ asset('/uploads/login.png') }}" style="width: 100%; height: 100%;" alt="">
                                </div>
                                    ...
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form class="forms-sample" method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="login" class="form-control" id="login" value="{{ old('login') }}" placeholder="Email/Phone/Name" required>
