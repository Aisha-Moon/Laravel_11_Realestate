                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="email" value="{{ old('email', $user->email) }}"  autocomplete="off" placeholder="Email" required readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="phone" value="{{ old('phone', $user->phone) }}"  placeholder="Mobile number">
                            </div>
                        </div>
                        <div class="row mb-3">
